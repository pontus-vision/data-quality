...
public enum MaskableCategoryEnum {
    ...
    FR_PHONE("FR Phone", FunctionType.GENERATE_PHONE_NUMBER_FRENCH), //$NON-NLS-1$
    UK_PHONE("UK Phone", FunctionType.GENERATE_PHONE_NUMBER_UK), //$NON-NLS-1$
    DE_PHONE("DE Phone", FunctionType.GENERATE_PHONE_NUMBER_GERMANY), //$NON-NLS-1$
